<?php 
	...
	$sql="SELECT sv.idCategoria, ct.categoria, psv.idServico, sv.servico, pr.nome FROM `tbprestadores_servicos` psv
	...
	WHERE psv.idServico = '$idServico' ORDER BY pr.nome";
