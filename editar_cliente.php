...
$query="UPDATE `tbclientes` SET `nome`='$nome',`endereco`='$endereco',`numero`='$numero',`complemento`='$complemento,`bairro`='$bairro',
`cep`='$cep',`cidade`='$cidade',`estado`='$estado',`cpf_cnpj`=$cpf,`rg`='$rg',`email`='$email',`data_nasc`='$data_nasc',
`telefone_fixo`=$telefone_fixo',`celular`='$celular' WHERE `tbclientes`.idCliente='$id'";
...
$resu= mysqli_query($con,$query);
	...
	if (mysqli_affected_rows($con)){
		$_SESSION['msg']="<p style='color:blue;'> Cliente alterado com sucesso!</p>";
		header('Location: result_cliente.php');	}
	else {
