...
<html>
    ...
    <?php  
        ...
        if (empty($pesq_1) && (empty($pesq_2))){
            ...
            $sql= "SELECT * FROM tbprestadores WHERE nome like '%$pesq_1%'";   
        }elseif (empty($pesq_1) && (!empty($pesq_2))){
            $sql= "SELECT * FROM tbprestadores WHERE cpf_cnpj like '%$pesq_2%'";  
        }else{
        ...
        while ($registro= mysqli_fetch_array($resultado)){
            ...
            echo "<td>".$celular."</td>";
			if ($restricao=="ADM"){
				echo "<td> <a href='alterar_prestador.php?id=".$row."'>Editar</a></td>";
				echo "<td> <a href='deletar_prestador.php?id=".$row."'>Excluir </a></td>";
				} 
            echo "</tr>";
        }
        mysqli_close($con);
        echo "</table>";
        ?>
        <br><a href="consulta_prestador.php">Voltar</a><br>
    </body>
</html>
